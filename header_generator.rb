...
class HeaderGenerator
  def parse(impl)
    ...
    generated = "/* Generated by OCHGen at #{generationDate}" <<
        " per annotation spec v.#{annotationSpecVersion} */\n\n" 
    ...
    generated.appendParagraph!( headerDeclaration.generate(:inlined) )
    ...
    implBlocks.each_index { |i|
      ...
      # ivar block
      # TODO this isn't going to scale to many def's in one .m file
      # TODO migrate to ImplBlockProcessor
