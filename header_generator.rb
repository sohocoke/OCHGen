...
class HeaderGenerator
  def parse(impl)
    ...
    propertiesFromSynthesize = PropertiesProcessor.parse(impl, :synthesize)
    
    generated.appendParagraph!( headerDeclaration.generate(:imports) )
    generated << ClassStartProcessor.new(impl).generate
    ...
    generated << "\n"
    generated << MethodPrototypesProcessor.new(impl).generate
    generated << "\n"
    generated << propertiesFromSynthesize.generate(:propertyDeclarationBlock)
    generated << PropertiesProcessor.parse(impl, :method).generate(:propertyDeclarationBlock)
